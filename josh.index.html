...
function trim(strText) {
    ...
    while (strText.substring(0,1) == ' ')
        strText = strTesxt.substring(1, strText.length);
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; color:#FF0">
            <div class="navbar-header" >
                ...
                <a class="navbar-brand" href="index.html">Fin guru </a> 
            </div>
           <!-- First home -->
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">Fin guru &nbsp; <div class="btn-group pull-right">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/index.jpeg" class="user-image img-responsive"/>
					</li>
